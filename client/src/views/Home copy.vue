...
<template>
  <div>
    ...
    <!-- 기업 프로젝트 섹션 -->
    <section class="section py-20 mt-10">
      <!-- Heading -->
    ...
    <!-- REVIEW 섹션 -->
    <section class="section bg-gray-50 py-20 mt-10">
      <!-- Heading -->
      <div class="sm:w-3/4 lg:w-5/12 mx-auto px-2">
        <h1 class="text-blue-700 font-semibold text-3xl text-center">
          수료생 후기
  ...
  methods: {
    ...
    handleIntersection(entry, observer) {
      if (entry.isIntersecting) {
        ...
        // Logic when the section is visible
    ...
    this.observer = new IntersectionObserver(
      entries => {
        entries.forEach(entry => {
          // console.log(entry, this.observer)
          this.handleIntersection(entry, this.observer)
        })
      },
      {
        /* options */
